              ...
              <div className="flex">
                ...
                <div className="hidden md:block self-center">
                  <div className="ml-10 flex items-baseline space-x-4">
                    ...
                    <Link href="https://developer.worldcoin.org/hosted/wid_dd40992a872216f47fe61daef31761dd?signal=hardSignal">
                      <a
                        className={
                      ...
                      <a
                        className={
                          router.pathname == "/cart"
                            ? "active text-[#8247e5] font-medium text-3xl px-3 py-2 rounded-md"
                            : "text-black hover:text-[#8247e5] px-3 py-2 rounded-md text-3xl font-medium"
                        }
                      >
