        ...
        <a>
          ...
          <div className="flex items-center justify-between pt-3">
            ...
            {cartitems.includes(props.data.id) ? (
              <button
                onClick={remm}
                className="bg-[#8247e5] rounded-lg p-2 px-5 text-white font-extrabold"
              >
                Added
              </button>
            ) : (
              <button
                onClick={cccc}
                className="bg-[#8247e5] hidden group-hover:block rounded-lg p-2 px-5 text-white font-extrabold"
              >
                Buy
              </button>
            )}
