...
const Cart = () => {
  ...
  const buyNFT = async () => {
    ...
    var aaa = "3aa30bac-2b28-46eb-bf34-4b41f8de87cd";
    var url = "https://api.nftport.xyz/v0/files";
      ...
      .then(function (response) {
        ...
        const options = {
          ...
          headers: {
            ...
            Authorization: "3aa30bac-2b28-46eb-bf34-4b41f8de87cd",
          },
          data: {
            name: "Zemoo #1",
            description: "Adidas yeezy 350 boost V2",
            file_url: response.data.ipfs_url,
            external_url: "https://zemoo--vaibhav.on.valist.io/",
          },
        };
        ...
        axios
          ...
          .then(function (response) {
            ...
            const options = {
              ...
              data: {
                chain: "polygon",
                contract_address: "0x4b6c8cdb70f68e7bf3bd3a1a700ecc4de240fbe8",
                metadata_uri: response.data.metadata_uri,
                mint_to_address: "0x53C959634274F4C1E5813Dbb68e102AefdBe5b81",
                token_id: "1",
              },
            };
